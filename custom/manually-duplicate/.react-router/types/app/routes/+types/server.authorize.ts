...
type Module = typeof import("../server.authorize.js")

export type Info = {
  parents: [Parent0, Parent1],
  id: "routes/server.authorize"
  file: "./routes/server.authorize.tsx"
  path: "server/authorize"
